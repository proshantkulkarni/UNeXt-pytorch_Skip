...
import os
from medformer_utils import SemanticMapGeneration
...
class UNext(nn.Module):
    ...
    def __init__(self,  num_classes, input_channels=3, deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        self.encoder2 = nn.Conv2d(16, 32, 3, stride=1, padding=1)  
        self.encoder3 = nn.Conv2d(32, 128, 3, stride=1, padding=1)
        self.semantic_map_cr1=SemanticMapGeneration(feat_dim=128, map_dim=128, map_size=104)
        self.semantic_map_cr2 = SemanticMapGeneration(feat_dim=256, map_dim=256, map_size=52)
        self.semantic_map_cr3=SemanticMapGeneration(feat_dim=128, map_dim=128, map_size=104)
