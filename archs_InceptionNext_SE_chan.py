...
class UNext(nn.Module):
    ...
    def __init__(self,  num_classes, input_channels=3, deep_supervision=False,img_size=224, patch_size=16, in_chans=3,  embed_dims=[ 128, 160, 256],
        ...
        print("UNext InceptionNext Channel SE Initiated")
        ...
        self.sse1 = ChannelSELayer(16)   # after t1_proj
        self.sse2 = ChannelSELayer(32)   # after t2_proj
        self.sse3 = ChannelSELayer(128)  # after t3_proj
        self.sse4 = ChannelSELayer(160)  # before patch_embed4 (t4 is not projected)
