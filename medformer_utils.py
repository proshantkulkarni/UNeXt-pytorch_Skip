...
from medformer_conv import DepthwiseSeparableConv, BasicBlock, Bottleneck, MBConv, FusedMBConv, ConvNormAct
...
class SemanticMapGeneration(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(semantic_map.view(B, self.map_dim, self.map_size, self.map_size).shape)
        # exit(0)
