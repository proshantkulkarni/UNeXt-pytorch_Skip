...
# ARCH_NAMES = archs_InceptionNext_MLFC.__all__

# import archs_medmamba
# ARCH_NAMES = archs_medmamba.__all__

# import archs_InceptionNext_atto
# ARCH_NAMES = archs_InceptionNext_atto.__all__

# import archs_ConvNext
# ARCH_NAMES = archs_ConvNext.__all__
...
def main():
    ...
    # model = archs_InceptionNext_SE.__dict__[config['arch']](
    #     config['num_classes'],
    #     config['input_channels'],
    #     config['deep_supervision']
    # ).to(device)

    # model = archs_InceptionNext_MLFC.__dict__[config['arch']](
    #     config['num_classes'],
    #     config['input_channels'],
    #     config['deep_supervision']
    # ).to(device)

    # model = archs_medmamba.__dict__[config['arch']](
    #     config['num_classes'],
    #     config['input_channels'],
    #     config['deep_supervision']
    # ).to(device)

    model = archs_InceptionNext_SE_chan.__dict__[config['arch']](
        config['num_classes'],
        config['input_channels'],
        config['deep_supervision']
    ).to(device)
    ...
    # model = archs_ConvNext.__dict__[config['arch']](
    #     config['num_classes'],
    #     config['input_channels'],
    #     config['deep_supervision']
    # ).to(device)
