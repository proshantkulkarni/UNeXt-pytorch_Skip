...
def main():
    ...
    # =============================
    # Inference/Validation on test data after training completes
    # =============================
    print("\n🔍 Running final validation on test data...")
        ...
        for input, target, meta in tqdm(val_loader, total=len(val_loader)):
            ...
            for i in range(len(output)):
                for c in range(config['num_classes']):
                    ...
                    dest_dir = os.path.join("models", config["name"], "results")
...
# === Save final metrics to CSV ===
    ...
    metrics_path = os.path.join("models", config["name"], "metrics_results.csv")
